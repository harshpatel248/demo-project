...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
        <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><span class="tx-normal"></span> Change <span class="tx-info">Password</span> <span class="tx-normal"></span></div>
        ...
        <div class="form-group">
          <input type="email" class="form-control" name="email" placeholder="Enter your email" value="<?php if(isset($_GET['email'])){ echo $_GET['email']; }?>">
      </div><!-- form-group -->
      <div class="form-group">
          <input type="password" class="form-control" name="new_password" id="new_password" placeholder="Enter the new password">
      </div>
      <div class="form-group">
          <input type="password" class="form-control" name="confirm_password" placeholder="Enter the Confirm password">
      </div>
      <button type="submit" class="btn btn-info btn-block" name="password_update">Update Password</button>
      </form>
  </div><!-- login-wrapper -->
</div><!-- d-flex -->
