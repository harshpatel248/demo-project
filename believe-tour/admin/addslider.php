...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `slider` (`title`,`heading`,`description`,`link`,`btn_txt`) VALUES ('$title','$heading','$description','$link','$btn_txt')";
  ...
  <div class="br-pagebody">
    <div class="col-sm-12">
      <div class="br-section-wrapper">
        <h6 class="br-section-label">Add Slider Content</h6>
          ...
          <div class="row mg-b-25">
            ...
            <div class="col-lg-12">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="heading" placeholder="Enter Slider heading">
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-12">
              <div class="form-group">
                <label class="form-control-label">Description: <span class="tx-danger">*</span></label>
                <textarea rows="3" class="form-control" placeholder="Add Description" name="description"></textarea>
              </div>
            </div><!-- col-4 -->
            <div class="col-lg-12">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Button link <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="link" placeholder="Enter button link">
              </div>
            </div>
            <div class="col-lg-12">
              <div class="form-group mg-b-10-force">
                <label class="form-control-label">Button text <span class="tx-danger">*</span></label>
                <input class="form-control" type="text" name="btn_txt" placeholder="Enter button text">
              </div>
            </div>
