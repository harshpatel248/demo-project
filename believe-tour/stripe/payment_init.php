...
if($jsonObj->request_type == 'create_payment_intent'){ 
    ...
    if(!empty($payment_intent) && $payment_intent->status == 'succeeded'){ 
        ...
        if(!empty($row_id)){ 
            ...
            // } 
            $sql_ins = "INSERT INTO transactions (customer_name,customer_email,item_name,item_price,item_price_currency,paid_amount,paid_amount_currency,txn_id,payment_status,created,modified) VALUES ('$customer_name','$customer_email','$itemName','$itemPrice','$currency','$paid_amount','$paid_currency','$transaction_id','$payment_status',NOW(),NOW())"; 
