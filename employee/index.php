...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO  `emp` (`name`,`email`,`password`,`gender`,`hobby`,`dob`,`image`) VALUES ('$fname','$email','$password','$gender','$hobby','$dob','$image')";
    ...
    <div class="container py-3">
        <form id="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <label class="checkbox-inline"><input type="checkbox" name="hobby[]" value="gaming">
                        gaming</label>
                    <label class="checkbox-inline"><input type="checkbox" name="hobby[]" value="chess">
                        chess</label>
                    <label class="checkbox-inline"><input type="checkbox" name="hobby[]" value="cricket">
                        cricket</label>
                </div>
                <div>
            ...
            <div class="form-group">
                    ...
                    <div class="input-group date form-check" class="datepicker" data-provide="datepicker">
                        <input type="text" class="form-control" name="dob" class="datepicker" id="datepicker" autocomplete="off">
                ...
                <img id="thumbnil" style="width:20%; margin-top:10px;" alt="image">
            </div>
